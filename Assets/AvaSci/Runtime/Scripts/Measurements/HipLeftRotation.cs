...
{
    public class HipLeftRotation : Measurement
    {
        public HipLeftRotation()
        {
            Type = MeasurementType.HipLeftRotation;
        ...
        public override void Update(Body body)
        {
            ...
            float angle = Calculations.Rotation(hip3D, knee3D, Plane.Transverse);

            if (knee3D.Y > hip3D.Y) angle = -angle;
